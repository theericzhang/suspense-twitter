                ...
                <div className="tweet-body">
                    ...
                    <div className="tweet-actions">
                        <div className="tweet-action-wrapper">
                            ...
                            <h4 className="tweet-action-counter" id="replyCounter">30</h4>
                        </div>
                        <div className="tweet-action-wrapper">
                            <button className="tweet-action-button">
                            ...
                            <h4 className="tweet-action-counter" id="retweetCounter">30</h4>
                        </div>
                        <div className="tweet-action-wrapper">
                            <button className="tweet-action-button">
                            ...
                            <h4 className="tweet-action-counter" id="reactCounter">30</h4>
                        </div>
                        <div className="tweet-action-wrapper">
                            <button className="tweet-action-button">
